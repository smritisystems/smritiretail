...
Revision ID: v1400_phase_e_auth_hardening
Revises: v900_multigroup_catmap
"""
...
revision: str = "v1400_phase_e_auth_hardening"
down_revision: Union[str, Sequence[str], None] = "v900_multigroup_catmap"
branch_labels = None
depends_on = None
