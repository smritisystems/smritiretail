...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('scope', sa.dialects.postgresql.JSONB(), nullable=False, server_default=sa.text("'{}'::jsonb")),
    ...
    op.create_table(
        ...
        sa.Column('identity_metadata', sa.dialects.postgresql.JSONB(), nullable=False, server_default=sa.text("'{}'::jsonb")),
