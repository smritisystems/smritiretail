...
def upgrade() -> None:
    ...
    if {'suppliers', 'purchase_orders', 'purchase_order_items', 'purchase_receipts', 'purchase_receipt_items'}.issubset(table_names):
        return
    ...
    if 'purchase_order_items' not in table_names:
        op.create_table(
            'purchase_order_items',
    ...
    # ── purchase_receipts ─────────────────────────────────────────────────────
    if 'purchase_receipts' not in table_names:
        op.create_table(
            'purchase_receipts',
    ...
    if 'purchase_receipt_items' not in table_names:
        op.create_table(
            'purchase_receipt_items',
