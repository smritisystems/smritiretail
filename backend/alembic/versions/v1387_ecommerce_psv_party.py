...
def upgrade() -> None:
    # ecom_channels - Marketplace connectors
    op.create_table(
        'ecom_channels',
    ...
    # ecom_sku_mappings - External to SMRITI SKU mapping
    op.create_table(
        'ecom_sku_mappings',
        sa.Column('id', sa.String(50), nullable=False),
        sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False),
    ...
    # ecom_order_imports - Order deduplication and convergence
    op.create_table(
        'ecom_order_imports',
        sa.Column('id', sa.String(50), nullable=False),
        sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False),
    ...
    # ecom_stock_sync_logs - Inventory broadcast audit
    op.create_table(
    ...
    # ecom_reconciliations - Channel settlement reconciliation
    op.create_table(
    ...
    # party_addresses - Multi-address support for parties
    op.create_table(
        'party_addresses',
        sa.Column('id', sa.String(50), nullable=False),
        sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False),
    ...
    # party_relationships - Inter-party hierarchies
    op.create_table(
        'party_relationships',
        sa.Column('id', sa.String(50), nullable=False),
        sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False),
    ...
    # psv_party_scopes - Visibility scope bindings
    op.create_table(
        'psv_party_scopes',
        sa.Column('id', sa.String(50), nullable=False),
        sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False),
    ...
    # psv_visibility_policies - Visibility policy definitions
    op.create_table(
