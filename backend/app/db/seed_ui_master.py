...
def seed_ui_master_data():
    ...
    """
    templates = [
        ("wt_supermarket", "wt_supermarket", "RETAIL_SUPERMARKET", "Retail & Supermarket Workspace", "SUPERMARKET", '["POS", "INVENTORY", "GST", "BATCH_EXPIRY_FEFO", "BARCODE", "LABEL_PRINTING"]', '{"default_view": "POS_FAST_BILLING", "widgets": ["DAILY_SALES", "FAST_MOVING_ITEMS", "SHIFT_CASH_DRAWER"]}', True, "ACTIVE", "High-throughput barcode scanning and cash drawer till workspace.", True, False, 1),
