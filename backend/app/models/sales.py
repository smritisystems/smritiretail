...
class SalesReturn(RowSecuredMixin, BaseEntity):
    ...
    original_invoice_id = Column(String(50), ForeignKey("sales_invoices.id", ondelete="RESTRICT"), nullable=True)
    ...
    tax_total           = Column(Numeric(15, 2), default=Decimal("0.00"))
    grand_total         = Column(Numeric(15, 2), nullable=False, default=Decimal("0.00"))
    cgst_total          = Column(Numeric(15, 2), nullable=False, server_default="0.00", default=Decimal("0.00"))
    sgst_total          = Column(Numeric(15, 2), nullable=False, server_default="0.00", default=Decimal("0.00"))
    igst_total          = Column(Numeric(15, 2), nullable=False, server_default="0.00", default=Decimal("0.00"))
...
class SalesOrderItem(Base):
    ...
    hsn_code          = Column(String(15), nullable=True)
    gst_rate          = Column(Numeric(5, 2), default=Decimal("18.00"))
    tax_amount        = Column(Numeric(15, 2), default=Decimal("0.00"))
    cgst_amount       = Column(Numeric(15, 2), nullable=False, server_default="0.00", default=Decimal("0.00"))
    sgst_amount       = Column(Numeric(15, 2), nullable=False, server_default="0.00", default=Decimal("0.00"))
    igst_amount       = Column(Numeric(15, 2), nullable=False, server_default="0.00", default=Decimal("0.00"))
