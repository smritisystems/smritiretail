...
Module       : Payment Gateway Webhook Handlers (Razorpay / Cashfree)
...
Purpose:
    Webhook processing for digital payment gateway callbacks (Razorpay, Cashfree).
    Auto-posts payment receipt entries upon signature validation.
"""
