...
@router.post("/einvoice/generate", dependencies=[Depends(require_permission("TAX.MANAGE_EWAY"))])
...
@router.post("/ewaybill/generate", dependencies=[Depends(require_permission("TAX.MANAGE_EWAY"))])
...
@router.get("/gstr1/summary", dependencies=[Depends(require_permission("TAX.VIEW"))])
