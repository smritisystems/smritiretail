...
class PurchaseService:
    ...
    async def create_supplier(self, req: SupplierCreate) -> Supplier:
        ...
        supplier = Supplier(
            ...
            order_multiple=req.order_multiple,
            preferred_language=req.preferred_language,
            transport_name=req.transport_name,
            transporter_gstin=req.transporter_gstin,
            freight_terms=req.freight_terms,
            default_label_template=req.default_label_template,
            default_barcode_type=req.default_barcode_type,
