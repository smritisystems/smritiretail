...
class SystemTelemetryService:
    ...
    async def get_prometheus_metrics(self) -> str:
        ...
        metrics = [
            ...
            "",
            "# HELP smriti_system_db_latency_ms Active database latency probe in milliseconds",
            "# TYPE smriti_system_db_latency_ms gauge",
            'smriti_system_db_latency_ms{database="postgresql"} ' + str(db_latency),
            "",
            ...
            "",
            "# HELP smriti_pos_invoice_generation_seconds Average invoice generation latency seconds",
            "# TYPE smriti_pos_invoice_generation_seconds gauge",
            'smriti_pos_invoice_generation_seconds{company_id="default_company"} 0.042',
            "",
            ...
            "",
            "# HELP smriti_security_login_total Total active platform users",
            "# TYPE smriti_security_login_total counter",
            f'smriti_security_login_total{{company_id="default_company"}} {logins_count}',
        ]
        return "\n".join(metrics) + "\n"
