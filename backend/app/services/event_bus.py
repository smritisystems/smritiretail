...
class Events:
    ...
    # SCDM — Channel Distribution Management (Platform Capability v1.0 & v1.1)
    ...
    SCDM_CLAIM_CREATED                    = "scdm.claim.created"
    SCDM_CLAIM_APPROVED                   = "scdm.claim.approved"
    SCDM_CLAIM_REJECTED                   = "scdm.claim.rejected"
    SCDM_SETTLEMENT_RECONCILED            = "scdm.settlement.reconciled"
