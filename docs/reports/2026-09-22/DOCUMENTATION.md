...
| B2B Dispatch Studio | ✅ | Documentation is up to date |
| POS Terminals | ✅ | Documentation is up to date |
| Purchase Studio | ✅ | Documentation is up to date |
| Goods Receipt (GRN) | ❌ | Write automated unit tests. |
...
| System Parameters Studio | ✅ | Documentation is up to date |
| Database Manager (DB Studio) | ✅ | Documentation is up to date |
