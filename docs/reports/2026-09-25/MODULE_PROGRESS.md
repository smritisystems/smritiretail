...
| :--- | :--- | :---: | :---: |
| Executive Hub | Operations | 88% | Low |
| SMRITI Gyan Kendra | Operations | 72% | Low |
...
| B2B Dispatch Studio | Sales & POS | 44% | High |
| POS Terminals | Sales & POS | 68% | Low |
| Purchase Studio | Inventory & Sourcing | 68% | Low |
| Goods Receipt (GRN) | Inventory & Sourcing | 52% | Medium |
...
| Inter-Godown Transfers | Inventory & Sourcing | 88% | Low |
| Stock Ledger | Inventory & Sourcing | 68% | Low |
| Master Framework | Data & Config | 68% | Low |
| Field Explorer (UFE) | Data & Config | 80% | Low |
| KPI Registry | Data & Config | 72% | Low |
| Channel Visibility | Data & Config | 72% | Low |
| Numbering Engine | Data & Config | 68% | Low |
| Approval Matrix | Data & Config | 72% | Low |
...
| Terms & Conditions | Data & Config | 68% | Low |
| Data Exchange Hub | Data & Config | 80% | Low |
| Company Setup Wizard | Operations | 80% | Low |
| About SMRITI | System | 84% | Low |
| Dev Intelligence Center | System | 76% | Low |
| Audit Logs | System | 68% | Low |
| System Parameters Studio | System | 48% | High |
| Database Manager (DB Studio) | System | 76% | Low |
