...
| SMRITI Gyan Kendra | ✅ Yes | Registered Walkthrough v3.4.0 |
...
| Screen & Policy Studio | ❌ Missing | None |
| Customer Insights | ❌ Missing | None |
| Consignment Studio | ❌ Missing | None |
| SCDM Channel Distribution | ❌ Missing | None |
| Item Master | ✅ Yes | Registered Walkthrough v3.4.0 |
| Barcode Studio | ✅ Yes | Registered Walkthrough v3.4.0 |
| Barcode Print Studio | ❌ Missing | None |
| Universal Label Printer | ❌ Missing | None |
...
| Official Product Website | ✅ Yes | Registered Walkthrough v3.4.0 |
| Live Documentation Portal | ❌ Missing | None |
| Customer Workspace Portal | ❌ Missing | None |
| Digital Ecosystem Hub | ❌ Missing | None |
