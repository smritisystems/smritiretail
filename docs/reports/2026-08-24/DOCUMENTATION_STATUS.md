...
| Billing Desk | ✅ | Documentation is up to date |
| Sales Studio | ✅ | Documentation is up to date |
| Create Tax Invoice (B2B) | ✅ | Write automated unit tests. |
...
| Supplier Dashboard | ✅ | Documentation is up to date |
| Business Ledger | ✅ | Write automated unit tests. |
...
| Warehouse & Batch Hub | ❌ | Write automated unit tests. |
...
| My Profile Dashboard | ✅ | Write automated unit tests. |
