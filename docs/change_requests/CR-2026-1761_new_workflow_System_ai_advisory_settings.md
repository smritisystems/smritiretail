...
# Change Request: CR-2026-1761 — NEW WORKFLOW `ai_advisory_settings`
...
- **Risk Level:** `HIGH`
- **Module:** System
- **Target Entity / Component:** AiAdvisoryConfigEngine
- **Change Name:** `ai_advisory_settings`
- **Business Reason:** AI Advisory Settings & Key Registry (Rule AOP-001 - Offline-First AI Engine Settings)

---

## Capability Review (GR-014)
- Existing components reviewed: Yes
- Reusable components identified: `backend/app/models/system.py`
