...
# Change Request: CR-2026-1763 — NEW WORKFLOW `intercompany_elimination`
...
- **Risk Level:** `HIGH`
- **Module:** Accounting
- **Target Entity / Component:** FinancialConsolidationEngine
- **Change Name:** `intercompany_elimination`
- **Business Reason:** Multi-company financial consolidation & inter-company elimination engine
