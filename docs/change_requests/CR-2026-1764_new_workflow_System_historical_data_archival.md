...
# Change Request: CR-2026-1764 — NEW WORKFLOW `historical_data_archival`
...
- **Risk Level:** `HIGH`
- **Module:** System
- **Target Entity / Component:** DataArchivalEngine
- **Change Name:** `historical_data_archival`
- **Business Reason:** Data archival & cold-storage JSON export engine (AOP-004)
