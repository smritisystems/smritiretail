...
# Change Request: CR-2026-1743 — NEW WORKFLOW `audit_trail_hash_chain`
...
- **Risk Level:** `HIGH`
- **Module:** Accounting
- **Target Entity / Component:** ImmutableAuditLedger
- **Change Name:** `audit_trail_hash_chain`
- **Business Reason:** MCA statutory audit trail & SHA-256 hash-chained edit log compliance (G.S.R. 235(E))
