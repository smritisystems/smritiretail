...
# Change Request: CR-2026-1742 — NEW INTEGRATION `ewaybill_validity`
...
- **Risk Level:** `HIGH`
- **Module:** Operations
- **Target Entity / Component:** GstEWayBillValidityCalculator
- **Change Name:** `ewaybill_validity`
- **Business Reason:** Automated GST E-WayBill Distance & Statutory Validity Engine (NIC Rule 138)
