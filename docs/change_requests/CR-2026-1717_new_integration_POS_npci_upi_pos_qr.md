...
# Change Request: CR-2026-1717 — NEW INTEGRATION `npci_upi_pos_qr`
...
- **Risk Level:** `HIGH`
- **Module:** POS
- **Target Entity / Component:** DynamicUPIQRGenerator
- **Change Name:** `npci_upi_pos_qr`
- **Business Reason:** NPCI compliant UPI QR string encoder with VPA, txn reference, amount, and CRC16 checksum
