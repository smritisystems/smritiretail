...
# Change Request: CR-2026-1635 — NEW INTEGRATION `prod_docker_nginx`
...
- **Risk Level:** `HIGH`
- **Module:** Operations
- **Target Entity / Component:** ProductionDeployment
- **Change Name:** `prod_docker_nginx`
- **Business Reason:** Production deployment compose stack, Nginx reverse proxy, SSL termination, systemd scripts
