...
# Change Request: CR-2026-1762 — NEW WORKFLOW `bom_kitting_assembly`
...
- **Risk Level:** `HIGH`
- **Module:** Inventory
- **Target Entity / Component:** BillOfMaterialsEngine
- **Change Name:** `bom_kitting_assembly`
- **Business Reason:** Production & Bill of Materials (BOM) Kitting Assembly Engine
