...
# Change Request: CR-2026-1741 — NEW WORKFLOW `inter_store_transit`
...
- **Risk Level:** `HIGH`
- **Module:** Inventory
- **Target Entity / Component:** StockTransferRequest
- **Change Name:** `inter_store_transit`
- **Business Reason:** Multi-store stock transfer & in-transit reservation engine
