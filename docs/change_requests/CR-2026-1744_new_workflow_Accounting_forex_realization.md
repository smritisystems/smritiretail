...
# Change Request: CR-2026-1744 — NEW WORKFLOW `forex_realization`
...
- **Risk Level:** `HIGH`
- **Module:** Accounting
- **Target Entity / Component:** ForexGainLossCalculator
- **Change Name:** `forex_realization`
- **Business Reason:** Multi-currency exchange rate & Forex realized/unrealized gain-loss engine
