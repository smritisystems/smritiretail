...
# Change Request: CR-2026-1752 — NEW WORKFLOW `promotional_pricing_matrix`
...
- **Risk Level:** `HIGH`
- **Module:** Sales
- **Target Entity / Component:** PromotionalPricingEngine
- **Change Name:** `promotional_pricing_matrix`
- **Business Reason:** Multi-tier promotional pricing & BOGO discount matrix engine
