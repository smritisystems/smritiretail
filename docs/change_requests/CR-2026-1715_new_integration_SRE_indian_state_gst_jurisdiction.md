...
# Change Request: CR-2026-1715 — NEW INTEGRATION `indian_state_gst_jurisdiction`
...
- **Risk Level:** `HIGH`
- **Module:** SRE
- **Target Entity / Component:** IndianStateRegistry
- **Change Name:** `indian_state_gst_jurisdiction`
- **Business Reason:** Indian 38 State/UT GST code registry, Place of Supply validator, and IGST vs CGST/SGST jurisdiction rules
