...
# Change Request: CR-2026-1754 — NEW WORKFLOW `asset_depreciation`
...
- **Risk Level:** `HIGH`
- **Module:** Accounting
- **Target Entity / Component:** FixedAssetDepreciationEngine
- **Change Name:** `asset_depreciation`
- **Business Reason:** Fixed asset management & depreciation scheduler engine (SLM & WDV)
