...
## 1. Overview & Scope
CMP-001 establishes the compatibility contracts and SemVer rules governing all domain releases building on top of the **SMRITI Platform Foundation Series (PAR-001 v1.0 Baseline)**.
...
## 3. SemVer Guarantees for Public Interfaces
