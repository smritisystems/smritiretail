...
- Importing Tax Invoice Workspace host [`src/components/TaxInvoicePrintPage.tsx`](file:///F:/SMRITRretailNX/src/components/TaxInvoicePrintPage.tsx).
- Importing backend dispatch import service [`backend/app/services/tattly_dispatch_import_service.py`](file:///F:/SMRITRretailNX/backend/app/services/tattly_dispatch_import_service.py).
- Importing GST exclusive 5% calculation pytest suite [`backend/tests/test_tax_invoice_gst_exclusive_calculation.py`](file:///F:/SMRITRretailNX/backend/tests/test_tax_invoice_gst_exclusive_calculation.py).
...
- [`src/components/TaxInvoicePrintPage.tsx`](file:///F:/SMRITRretailNX/src/components/TaxInvoicePrintPage.tsx): SEEF & UCR-001 compliant Tax Invoice workspace host with live branding customization panel.
- [`src/kernel/SPK.ts`](file:///F:/SMRITRretailNX/src/kernel/SPK.ts): SPK kernel configuration facade for branding persistence.
- [`backend/app/services/tattly_dispatch_import_service.py`](file:///F:/SMRITRretailNX/backend/app/services/tattly_dispatch_import_service.py): Backend dispatch import & statutory invoice lifecycle calculation service.
- [`backend/tests/test_tax_invoice_gst_exclusive_calculation.py`](file:///F:/SMRITRretailNX/backend/tests/test_tax_invoice_gst_exclusive_calculation.py): Pytest suite asserting 5% exclusive IGST calculation mandates.
- [`docs/walkthrough/sales/SMRITI_Statutory_A4_Tax_Invoice_Print_Engine_v4.7.0.md`](file:///F:/SMRITRretailNX/docs/walkthrough/sales/SMRITI_Statutory_A4_Tax_Invoice_Print_Engine_v4.7.0.md): This walkthrough document.
...
## 8. Tests Executed
```bash
python -m pytest tests/test_tax_invoice_gst_exclusive_calculation.py -v
npx vite build
```

## 9. Verification Results
```text
tests/test_tax_invoice_gst_exclusive_calculation.py: 2/2 PASSED in 1.56s
