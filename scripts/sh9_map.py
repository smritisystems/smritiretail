...
MAPPING = {
    ...
    (410,418): ("reports_portal", "VIEW",  "TOP_SELLING",         "MAPPED", "Reports: Top Selling Items."),
    (410,419): ("reports_portal", "VIEW",  "SALESPERSON_SALES",   "MAPPED", "Reports: Salesperson Sales."),
    (410,420): ("reports_portal", "VIEW",  "CANCELLED_BILLS",     "MAPPED", "Reports: Cancelled Bills."),
    (410,421): ("reports_portal", "VIEW",  "RETURNED_BILLS",      "MAPPED", "Reports: Returned Bills."),
    (410,422): ("reports_portal", "VIEW",  "ATTR_SIZE_SALES",     "MAPPED", "Reports: Attribute+Size-wise Sales."),
    (410,423): ("reports_portal", "VIEW",  "DAYWISE_SUMMARY",     "MAPPED", "Reports: Day-wise Sales Summary."),
    (410,425): ("reports_portal", "VIEW",  "ITEMWISE_RETURNS",    "MAPPED", "Reports: Item-wise Sales Returns."),
