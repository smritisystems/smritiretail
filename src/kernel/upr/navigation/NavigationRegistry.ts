    ...
    const defaults: DomainDefinition[] = [
      ...
      },
      {
        ...
        modules: [
          ...
          { id: NAV_IDS.BARCODE, title: "Barcode Studio", icon: "Printer", targetTab: "barcode", workspaceId: "barcode", route: "/inventory/barcode", order: 4, visible: true, owner: "SMRITI", packageId: "smriti.inventory.barcode", version: "6.0.0", dependsOn: ["item-master"] },
          { id: NAV_IDS.PRINT_STUDIO, title: "Label Printer Hub", icon: "Printer", targetTab: "print-studio", workspaceId: "print-studio", route: "/inventory/print-studio", order: 5, visible: true, owner: "SMRITI", packageId: "smriti.inventory.printhub", version: "6.0.0", dependsOn: ["barcode"] },
          { id: "universal-label-printer", title: "Universal Label Printer", icon: "Printer", targetTab: "universal-label-printer", workspaceId: "universal-label-printer", route: "/inventory/label-printer", order: 6, visible: true, owner: "SMRITI", packageId: "smriti.inventory.labelprinter", version: "6.0.0", dependsOn: ["print-studio"] },
        ]
      },
      {
        id: "purchase",
