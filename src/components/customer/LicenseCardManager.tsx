...
export const LicenseCardManager: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div className="bg-theme-surface-2 border border-theme-divider rounded-2xl p-6 flex justify-between items-center">
        <div>
          <h2 className="text-xl font-bold text-white mb-1">Active Software Licenses</h2>
          <p className="text-theme-muted text-xs">Manage active license keys, store allocations, and terminal caps.</p>
        </div>
      ...
      {licenses.map((lic, idx) => (
        <div key={idx} className="bg-theme-surface-2 border border-theme-divider rounded-2xl p-6 space-y-6">
          <div className="flex flex-wrap items-center justify-between gap-4 pb-6 border-b border-theme-divider">
            <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-4 bg-theme-surface-3 border border-theme-divider rounded-xl space-y-2">
              ...
              <div className="w-full bg-theme-surface-2 h-2 rounded-full overflow-hidden">
          ...
          {/* Enabled Modules */}
          <div>
            <span className="block text-xs font-semibold text-theme-muted mb-3">Licensed Platform Modules:</span>
            <div className="flex flex-wrap gap-2">
              {lic.modules.map((m, i) => (
                <span key={i} className="px-3 py-1 bg-theme-surface-2 border border-theme-divider text-theme-body text-xs rounded-lg flex items-center gap-1.5">
