              ...
              <div className="flex-1 overflow-y-auto p-5 space-y-5">
                ...
                <div className="flex items-start justify-between flex-wrap gap-3">
                  <div>
                    ...
                    {selected.logisticsRef && <p className="text-xs text-cyan-400 font-mono mt-0.5">📦 {selected.logisticsRef}{selected.expectedArrival && ` · ETA: ${selected.expectedArrival}`}</p>}
                  </div>
                  <div className="flex items-center gap-2">
