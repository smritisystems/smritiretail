  ...
  if (cart.length === 0) {
    return (
      ...
      <div className="w-full h-full min-h-[350px] bg-theme-base border border-theme-divider rounded-xl flex flex-col items-center justify-center p-8 text-center select-none font-sans">
        ...
        <h4 className="text-sm font-bold text-theme-heading uppercase tracking-wide font-display">
          Terminal Item Grid Ready
        </h4>
        <p className="text-xs text-theme-muted max-w-sm mt-1 font-mono">
                  ...
                  {salespersonMode === "line" && (
                    <td className="py-3 px-4 text-center">
                      <select
                        ...
                        className="bg-theme-surface-2 border border-theme-divider text-theme-body text-xs rounded px-2 py-1 focus:outline-none w-full max-w-[140px]"
                      >
                        {salespersons.map(s => (
