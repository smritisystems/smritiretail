  ...
  return (
    <div className="w-full h-full overflow-y-auto bg-theme-base text-theme-body p-6 md:p-8 font-sans">
      <div className="max-w-4xl mx-auto space-y-6 pb-12">
          ...
          <div className="space-y-1.5">
            <div className="flex items-center gap-2 mb-1">
              <span className="px-2.5 py-0.5 text-xs font-mono rounded bg-[#354a5e] text-white border border-[#4c6680] flex items-center gap-1.5 shadow-xs">
                <Sparkles className="w-3.5 h-3.5 text-[#6fa8dc]" /> Rule AI-001 / AOP-001 Certified
              </span>
            </div>
            <h1 className="text-2xl font-bold tracking-tight text-theme-heading flex items-center gap-2">
              <Bot className="w-6 h-6 text-[#0a6ed1]" /> AI Engine Configuration
            </h1>
        ...
        <div className="bg-[#0a6ed1]/10 border border-[#0a6ed1]/30 rounded-lg p-4 text-xs leading-relaxed text-theme-heading flex items-start gap-3">
          <ShieldAlert className="w-5 h-5 text-[#0a6ed1] shrink-0 mt-0.5" />
          <div>
            <strong className="font-bold text-[#0a6ed1]">Product Governance Rule AI-001:</strong>
        ...
        {loading ? (
          <div className="bg-theme-surface-1 border border-theme-divider rounded-lg p-12 text-center text-sm text-theme-muted flex items-center justify-center gap-2">
            <RefreshCw className="w-4 h-4 animate-spin text-[#0a6ed1]" /> Loading configuration...
          </div>
        ) : (
          <form onSubmit={handleSave} className="space-y-6">
            ...
            <div className="bg-theme-surface-1 border border-theme-divider rounded-lg p-6 shadow-xs space-y-4">
              <h2 className="text-sm font-bold uppercase tracking-wider text-theme-muted flex items-center gap-2 border-b border-theme-divider pb-2">
                <Cpu className="w-4 h-4 text-[#0a6ed1]" /> Activation & Master Switch
              </h2>

              <label className="flex items-center justify-between p-4 rounded-lg bg-theme-surface-2 border border-theme-divider cursor-pointer hover:border-[#0a6ed1] transition-all">
                ...
                <input
                  ...
                  className="w-5 h-5 rounded border-theme-divider text-[#0a6ed1] focus:ring-[#0a6ed1] accent-[#0a6ed1] cursor-pointer"
                />
              </label>
            </div>
            ...
            <div className="bg-theme-surface-1 border border-theme-divider rounded-lg p-6 shadow-xs space-y-5">
              <h2 className="text-sm font-bold uppercase tracking-wider text-theme-muted flex items-center gap-2 border-b border-theme-divider pb-2">
                <Bot className="w-4 h-4 text-[#0a6ed1]" /> AI Provider & Credentials
              </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <select
                    ...
                    className="w-full bg-theme-surface-2 border border-theme-divider rounded-lg px-3 py-2 text-xs text-theme-heading focus:ring-2 focus:ring-[#0a6ed1] disabled:opacity-50"
                  >
                    {PROVIDERS.map((p) => (
                ...
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full bg-theme-surface-2 border border-theme-divider rounded-lg px-3 py-2 text-xs text-theme-heading focus:ring-2 focus:ring-[#0a6ed1] disabled:opacity-50 font-mono"
                  />
                </div>
              </div>
              ...
              {selectedProviderInfo.requiresKey && (
                <div className="space-y-1.5">
                  <label className="text-xs font-semibold text-theme-heading flex items-center gap-1">
                    <Key className="w-3.5 h-3.5 text-[#0a6ed1]" /> API Key ({selectedProviderInfo.name})
                  </label>
                  <div className="relative">
                    <input
                      ...
                      className="w-full bg-theme-surface-2 border border-theme-divider rounded-lg pl-3 pr-10 py-2 text-xs font-mono text-theme-heading focus:ring-2 focus:ring-[#0a6ed1] disabled:opacity-50"
                    />
                    <button
                      type="button"
            ...
            <div className="bg-theme-surface-1 border border-theme-divider rounded-lg p-6 shadow-xs space-y-5">
              <h2 className="text-sm font-bold uppercase tracking-wider text-theme-muted flex items-center gap-2 border-b border-theme-divider pb-2">
                <Sliders className="w-4 h-4 text-[#0a6ed1]" /> Execution & Safety Limits
              </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full bg-theme-surface-2 border border-theme-divider rounded-lg px-3 py-2 text-xs font-mono text-theme-heading focus:ring-2 focus:ring-[#0a6ed1] disabled:opacity-50"
                  />
                </div>
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-semibold text-theme-heading flex items-center gap-1">
                    <Clock className="w-3.5 h-3.5 text-[#0a6ed1]" /> Timeout (Seconds)
                  </label>
                  <input
                    type="number"
                    disabled={!config.enabled}
            ...
            <div className="flex items-center justify-between pt-4 border-t border-theme-divider">
              ...
              <button
                type="submit"
                disabled={saving}
                className="px-5 py-2.5 rounded-lg bg-[#0a6ed1] hover:bg-[#0854a0] text-white text-xs font-bold transition-all shadow-xs flex items-center gap-2 disabled:opacity-50 cursor-pointer"
              >
