...
vi.mock("../common/AdaptiveWorkspaceHeader.tsx", () => ({
  AdaptiveWorkspaceHeader: () => <div>Adaptive Workspace Header</div>,
}));
...
describe("WorkspaceToolbar", () => {
  it("does not render the global workspace header", () => {
    const html = renderToStaticMarkup(<WorkspaceToolbar currentTabId="sales" />);
