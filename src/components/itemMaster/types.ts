...
export const ALL_AVAILABLE_ITEM_FIELDS: ItemMasterFieldDefinition[] = [
  ...
  { id: "uom", key: "uom", label: "UOM", isMandatory: false, type: "select", width: "90px", options: [], aliases: ["Unit", "Unit of Measure"] },
  ...
  { id: "warehouseId", key: "warehouseId", label: "Warehouse", isMandatory: false, type: "select", width: "140px", aliases: ["Warehouse Code", "Godown"] },
