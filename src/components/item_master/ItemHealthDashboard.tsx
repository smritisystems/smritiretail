...
export const ItemHealthDashboard: React.FC<ItemHealthDashboardProps> = ({
  ...
  return (
    <div className="space-y-4 font-sans text-xs">
      ...
      <div className="p-5 bg-gradient-to-r from-purple-950/60 via-slate-900 to-indigo-950/60 border border-purple-500/30 rounded-2xl flex flex-col md:flex-row items-start md:items-center justify-between gap-4 shadow-md">
        ...
        <div className="flex items-center gap-2 font-mono text-xs">
          <div className="px-3 py-1.5 rounded-lg bg-white/5 border border-white/10 text-slate-200 font-bold">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
        ...
        <button
          ...
          className={`p-3 rounded-xl border text-left transition-all cursor-pointer ${
            filterType === "INACTIVE"
              ? "bg-slate-500/10 border-slate-500 shadow-xs"
              : "bg-theme-surface-2 border-theme-divider hover:bg-theme-surface-hover"
          }`}
        >
          ...
          <div className="text-xl font-black text-slate-400 mt-1">{analytics.inactiveCount}</div>
        </button>
      </div>
