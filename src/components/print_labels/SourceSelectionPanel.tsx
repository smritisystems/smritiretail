 ...
 *
 * Version    : 3.37.0 (Source Selection Panel Sub-Component - 13 Options)
 * Created    : 2026-07-25
  ...
  return (
    <div className="bg-[#141726] border border-slate-800 rounded-2xl p-4 space-y-3 shadow-xl font-mono text-xs">
      ...
      <div className="grid grid-cols-1 gap-1 max-h-56 overflow-y-auto pr-1">
        <label className="flex items-center gap-2 cursor-pointer p-1 rounded hover:bg-slate-800/40">
        ...
        {optionMode === "purchase_pt" && (
          <div className="pl-6 py-1 flex items-center gap-2">
            ...
            <input 
              ...
              className="bg-[#0a0c14] border border-slate-800 rounded px-2 py-0.5 text-indigo-300 text-xs flex-1" 
            />
          </div>
        )}
