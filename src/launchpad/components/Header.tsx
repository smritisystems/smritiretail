 ...
 * Module       : Zone A — Shell Header Component
    ...
    <div className="bg-theme-surface-1 border border-theme-divider rounded-lg p-5 shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-4">
      ...
      <div className="space-y-1">
        <div className="flex items-center gap-2 mb-1">
          <span className="px-2.5 py-0.5 text-[11px] font-mono rounded bg-[#354a5e] text-white border border-[#4c6680] flex items-center gap-1.5 shadow-xs">
            <Sparkles className="w-3.5 h-3.5 text-[#6fa8dc]" /> SLP-001 Desktop v5.4
          </span>
      ...
      <div className="flex items-center gap-3">
        <div
          ...
          className="w-full md:w-64 bg-theme-surface-2 border border-theme-divider hover:border-[#0a6ed1] rounded-lg px-3 py-2 text-xs text-theme-muted flex items-center justify-between cursor-pointer transition-all shadow-xs"
        >
          <span className="flex items-center gap-2">
            <Search className="w-3.5 h-3.5 text-[#0a6ed1]" />
            Search (Ctrl+K)...
          </span>
        ...
        >
          ...
          <span className="w-2 h-2 rounded-full bg-[#0a6ed1] absolute top-1.5 right-1.5 animate-pulse" />
        </button>
        ...
        <button
          ...
          title="User Profile"
        >
          <User className="w-4 h-4 text-[#0a6ed1]" />
        </button>
      </div>
    </div>
  );
