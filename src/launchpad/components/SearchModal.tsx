      ...
      <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-xs flex items-start justify-center pt-20 p-4">
        ...
        >
          ...
          <div className="p-4 border-b border-theme-divider flex items-center gap-3">
            <Search className="w-5 h-5 text-[var(--c-seef-accent)]" />
            <input
              type="text"
              autoFocus
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className="p-2 rounded bg-theme-surface-1 border border-theme-divider text-[var(--c-seef-accent)]">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <ChevronRight className="w-4 h-4 text-theme-muted group-hover:text-[var(--c-seef-accent)] group-hover:translate-x-1 transition-all" />
                    </div>
                  </div>
                );
              })
          ...
          <div className="p-3 border-t border-theme-divider bg-theme-surface-2 flex items-center justify-between text-[11px] font-mono text-theme-muted">
            <span>Use â†‘ â†“ keys to navigate, ENTER to select</span>
