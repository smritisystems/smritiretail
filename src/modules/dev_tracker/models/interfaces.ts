...
import { EvidenceItem, ModuleEvidence, AdapterStatus, ScannerFingerprint, ScannerHealth, ArchitectureCoverage, ScanDiff, ImpactAnalysisResult, DependencyGraphResult } from "../scanner/adapters/types.ts";
