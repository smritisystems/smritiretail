...
// Stubs for IndexedDB (to be populated in Web PWA browser deployments)
...
export class IndexedDbShiftRepository implements IShiftRepository {
...
export class IndexedDbSalesInvoiceRepository implements ISalesInvoiceRepository {
...
export class IndexedDbPOSProfileRepository implements IPOSProfileRepository {
...
export class IndexedDbPurchaseRepository implements IPurchaseRepository {
...
export class IndexedDbStateRepository implements IStateRepository {
